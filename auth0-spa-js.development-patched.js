    ...
    */
    ...
    var Auth0Client = /** @class */ (function () {
        ...
        Auth0Client.prototype.getTokenSilently = function (options) {
            if (options === void 0) { options = {}; }
            return __awaiter(this, void 0, void 0, function () {
                var _a, ignoreCache, getTokenOptions, getAccessTokenFromCache, accessToken, accessToken, authResult, _b;
                var _this = this;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 3:
                            ...
                            if (!this.options.useRefreshTokens) return [3 /*break*/, 5];
                            return [4 /*yield*/, this._getTokenUsingRefreshToken(getTokenOptions)];
                        case 4:
                            _b = _c.sent();
                            return [3 /*break*/, 7];
                        case 5: return [4 /*yield*/, this._getTokenFromIFrame(getTokenOptions)];
                        case 6:
                            _b = _c.sent();
                            _c.label = 7;
                        case 7:
                            ...
                            console.log("return access_token", authResult.access_token);
        ...
        Auth0Client.prototype._getTokenUsingRefreshToken = function (options) {
            return __awaiter(this, void 0, void 0, function () {
                var cache, redirect_uri, tokenResult, scope, audience, ignoreCache, timeoutInSeconds, customOptions, timeout, e_1, decodedToken;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 5:
                            e_1 = _a.sent();
                            if (!(e_1.message === MISSING_REFRESH_TOKEN_ERROR_MESSAGE)) return [3 /*break*/, 7];
                            return [4 /*yield*/, this._getTokenFromIFrame(options)];
